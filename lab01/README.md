...
C++ is considered as a superset of the C programming; which means some language-specific features aren't understood by the C compiler. For example, if you try to compile a C++ application with this line:
```
auto x = 4;
