...
#define BCM2837_GPFSEL0 (BCM2837_GPIO_BASE)         // Function-Select-0 
#define BCM2837_GPFSEL1 (BCM2837_GPIO_BASE + 0x04)  // Function-Select-1
#define BCM2837_GPFSEL2 (BCM2837_GPIO_BASE + 0x08)  // Function-Select-2
#define BCM2837_GPSET0 (BCM2837_GPIO_BASE + 0x1C)   // Set-0
#define BCM2837_GPCLR0 (BCM2837_GPIO_BASE + 0x28)   // Clear-0
